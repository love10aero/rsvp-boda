...
export default function App() {
  ...
  if (submitted) {
    return (
      <Background>
        <div className="bg-white bg-opacity-95 px-10 py-8 rounded-2xl shadow-lg backdrop-blur-sm border border-amber-200 relative">
          ...
          <h2 className="text-3xl text-center text-emerald-700 relative">
            ...
            <span className="absolute bottom-1 left-0 w-full h-1 bg-amber-200 opacity-50"></span>
          </h2>
  ...
  return (
    <Background>
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-5xl">
        <div className="w-full md:w-1/2 flex justify-center items-start mb-6 md:mb-0">
          <img 
            src="/Moment romantique minimaliste en noir et blanc-Photoroom.png" 
            alt="Pareja" 
            className="w-64 md:w-80 max-w-full rounded-2xl border-2 border-amber-100 shadow-lg object-cover" 
            style={{
              filter: 'drop-shadow(0 4px 6px rgba(0, 0, 0, 0.1))'
            }}
          />
        </div>
        <form onSubmit={handleSubmit} className="bg-white bg-opacity-95 p-8 rounded-2xl shadow-xl w-full md:w-1/2 space-y-6 border border-amber-200">
